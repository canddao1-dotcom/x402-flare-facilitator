...
```bash
# Set facilitator wallet via environment variable (NEVER commit keys!)
...
⚠️ **SECURITY**: Never create key files in the repo. Always use environment variables or secure secret managers.
